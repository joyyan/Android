...
public class CFTextAreaView extends CFTextEditView {
	...
	public CFTextAreaView(Context context,ElementDataVO viewAttribute) {
	...
	public void setTitle(String title){
		MaxByteLengthEditText tv = (MaxByteLengthEditText)rootView.findViewById(R.id.cfViewTextEdit);
		tv.setHint(title);
	}
